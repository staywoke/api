module.exports = {
  up: (queryInterface) => {
    return queryInterface.bulkInsert('geo_counties', [
      {
        country_id: 1,
        state_id: 20,
        name: 'Boone',
      ...
      updateOnDuplicate: ['country_id', 'state_id', 'name', 'fips_state_code', 'fips_county_code', 'modified_date']
    }).catch((err) => {
      if (err && err.errors) {
  ...
  down: (queryInterface) => {
    return queryInterface.bulkDelete('geo_counties', null, {})
  }
}
