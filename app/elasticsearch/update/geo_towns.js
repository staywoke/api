/**
 * @module elasticsearch/update/geo_towns
 * @version 1.0.0
...
const { prepareForElasticSearch } = require('../../api/v1/domain/geo_towns')

const env = config.get('env')
const indexType = `${env}_geo_towns`
...
module.exports = {
  ...
  update () {
    elasticsearchClient.search({
      ...
      return models.geo_towns.findAll(params)
    }).then((results) => {
      if (results.length) {
        const bulkActions = []
